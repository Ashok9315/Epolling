...
public partial class addCandidates : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Page.IsPostBack)
        {
            ...
            string c = "select id from elections where id=" + DropDownList1.SelectedValue;
    ...
    protected void select_Click(object sender, EventArgs e)
    {
        ...
        string command = "insert into selected_candidates values ('" + firstColData + "'," + Convert.ToInt32(Label1.Text) + ",'" + DropDownList1.SelectedItem.Text + "')";
